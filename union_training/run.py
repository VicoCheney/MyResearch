...
def main_parser(parser):
    ...
    parser.add_argument('--num_samples', type=str, default='1,1', help='num of continous, discrete random samples and promising samples')
    ...
    parser.add_argument('--train_source', type=str, default=os.path.join(os.getcwd(), '../data', 'pubmed_mini_train.pkl'), help='training dataset')
    parser.add_argument('--test_source', type=str, default=os.path.join(os.getcwd(), '../data', 'pubmed_mini_test.pkl'), help='test dataset')
    parser.add_argument('--validation_source', type=str, default=os.path.join(os.getcwd(), '../data', 'pubmed_mini_validation.pkl'), help='validation dataset')
    ...
    parser.add_argument('--levelup_threshold', type=float, default=0.15, help='gradient batch_size')
    parser.add_argument('--leveldown_threshold', type=float, default=-0.1, help='gradient batch_size')
